    ...
    <div class="lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
      <div class="lg:pr-4">
        <div class="lg:max-w-lg">
          <p class="text-base font-semibold leading-7 text-primary">Asesora</p>
          <h1 class="mt-2 text-3xl font-bold tracking-tight text-Third sm:text-4xl">Ten en cuenta</h1>
          <p class="mt-6 text-xl leading-8 text-gray-700">Somos una entidad sin ánimo de lucro, que buscamos el bienestar social de nuestros asociados y sus familias satisfaciendo sus necesidades básicas a través del ahorro y el crédito.</p>
        </div>
      </div>
    </div>
    <div class="-ml-12 -mt-12 p-12 lg:sticky lg:top-4 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden">
    <div class="grid grid-cols-3 gap-4 place-items-center h-56 relative  shadow-inner border-2  rounded-lg ">
