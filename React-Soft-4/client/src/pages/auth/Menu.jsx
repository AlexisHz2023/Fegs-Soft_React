...
const Menu = () => {
  ...
  return (
    <div className='bg-white py-5 fixed rounded-lg left-20 right-0 w-[90%] border-primary top-7 shadow-md z-20 border-2 ' >
      ...
      <button className='ml-4 relative text-primary ' onClick={() => setOpen(true)}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
          <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
        </svg><Registro /><h1 className='fixed text-3xl top-11 text- left-[7%] px-10 py-2 ps-5'>Menu de navegacion</h1>
      </button>




      <div className={`${open ? "w-80" : "w-14 bg-white"}  shadow-gray-700/50 shadow-lg z-20  bg-blue-500 border-2 border-primary   h-[60%]  rounded-xl fixed top-32 left-14 transition-all duration-300`}>
        <div className={`${!open && "hidden"} pt-3`}>
          <button className='ml-4 text-white z-20 mb-14' onClick={() => setOpen(false)}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-16 rounded-lg right-7 h-8 z-20 relative bg-primary hover:bg-Third ">
          ...
          <div className='bg-white relative h-28 rounded-lg -top-[100px]'>
            ...
            <h1 className='text-Third left-40 text-3xl -top-2 relative'>Fegs Soft</h1>
